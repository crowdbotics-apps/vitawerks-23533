"""vitawerks_23533 URL Configuration
...
admin.site.site_header = "Vitawerks"
admin.site.site_title = "Vitawerks Admin Portal"
admin.site.index_title = "Vitawerks Admin"

# swagger
api_info = openapi.Info(
    title="Vitawerks API",
    default_version="v1",
    description="API documentation for Vitawerks App",
)
